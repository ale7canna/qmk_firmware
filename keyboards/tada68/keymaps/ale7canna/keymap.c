...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * ,----------------------------------------------------------------------------------------------.
   * |EXT/` |   1|    2|    3|    4|    5|    6|    7|    8|    9|    0|   - |   = |  ~` |   |      |
   * |----------------------------------------------------------------------------------------------|
   * |Tab    |    Q|    W|E/GUI|    R|    T|    Y|    U|I/GUI|    O|    P|    [|    ]|    \  |  Del |
   * |----------------------------------------------------------------------------------------------|
   * |Esc      |A/CUR|S/ALT|D/CTL|F/SFT|G/MET|H/MET|J/SFT|K/CTL|L/ALT|    ;|    '|  Return   |  PgUp|
   * |----------------------------------------------------------------------------------------------|
   ...
   */
[BASE] = KEYMAP_ANSI(
  MY_ESC ,  KC_1  ,   KC_2 ,   KC_3 ,   KC_4 ,   KC_5 ,   KC_6 ,   KC_7 ,   KC_8 ,   KC_9 ,   KC_0 , KC_MINS, KC_EQL ,  KC_GRV, _______, \
  KC_TAB ,  KC_Q  ,   KC_W ,   MY_E ,   KC_R ,   KC_T ,   KC_Y ,   KC_U ,   MY_I ,   KC_O ,   KC_P , KC_LBRC, KC_RBRC, KC_BSLS,  KC_DEL, \
  KC_ESC ,  MY_A  ,   MY_S ,   MY_D ,   MY_F ,   MY_G ,   KC_H ,   MY_J ,   MY_K ,   MY_L , KC_SCLN, KC_QUOT,           KC_ENT, KC_PGUP, \
...
[CURS] = KEYMAP_ANSI(
  ...
  _______, _______, _______,                        _______,                       _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R),
     ...
     * |     |     |     |     |     |     |     |     |     |     |     |     |     |         |    |
     * |--------------------------------------------------------------------------------------------|
     * |VolUp  |     |Led-|Led|/O|Led +|     |     |Led-|Led|/O|Led +|     |     |     |       |VoUp|
     * |--------------------------------------------------------------------------------------------|
...
[EXTR] = KEYMAP_ANSI(
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  KC_VOLU, _______, BL_DEC , BL_TOGG,  BL_INC, _______, _______, BL_DEC , BL_TOGG,  BL_INC, _______, _______, _______, _______, KC_VOLU,
