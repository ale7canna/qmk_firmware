...
[BASE] = LAYOUT_65_ansi(
  ...
  KC_ESC ,  MY_A  ,   MY_S ,   MY_D ,   MY_F ,   MY_G ,   MY_H ,   MY_J ,   MY_K ,   MY_L , KC_SCLN, KC_QUOT,           KC_ENT, KC_PGUP, \
...
[EXTR] = LAYOUT_65_ansi(
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  KC_VOLU, _______, BL_DOWN, BL_TOGG,   BL_UP, _______, _______, BL_DOWN, BL_TOGG,   BL_UP, _______, _______, _______, _______, KC_VOLU,
